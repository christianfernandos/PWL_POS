                            ...
                            <div class="col-12 mb-4">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="position-relative me-3">
                                        <label for="avatar" class="cursor-pointer mb-0" style="cursor: pointer;">
                                            @if($user->avatar)
                                            <img src="{{ asset('storage/photos/' . $user->avatar) }}" class="rounded-circle" style="width: 80px; height: 80px; object-fit: cover;">
                                            @else
